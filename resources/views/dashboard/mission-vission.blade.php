      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            @if (session('success'))
                    ...
                    @endif
            <form action="{{ route('mission-vision-store')}}" method="POST">
                @csrf
                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="mission" class="form-control" id="" cols="60" rows="6"></textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <h4 class="card-title">Vision</h4>
                                        <textarea name="vission" class="form-control" id="" cols="60" rows="6"></textarea>
                                    </div>
                                </div>
